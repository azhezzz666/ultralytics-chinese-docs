---
description: 探索 Ultralytics 中有价值的 torch 工具，用于优化模型性能，包括设备选择、模型融合和推理优化。
keywords: Ultralytics, torch utils, 模型优化, 设备选择, 推理优化, 模型融合, CPU 信息, PyTorch 工具
---

# `ultralytics/utils/torch_utils.py` 参考

!!! success "改进建议"

    本页面源自 [https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py](https://github.com/ultralytics/ultralytics/blob/main/ultralytics/utils/torch_utils.py)。有改进建议或示例要添加？请提交 [Pull Request](https://docs.ultralytics.com/help/contributing/) — 感谢！🙏
